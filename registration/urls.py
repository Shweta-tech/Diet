...
urlpatterns = [
    ...
    url(r'^sam_mam_child_parents_profile/$',views.SMChildParentsprofile, name='sam_mam_child_parents_profile'),url(r'^nutri_garden_expert_register/$', views.nutri_garden_expert, name='nutri_garden_expert_register'),
