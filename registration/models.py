...
class AnemicAdolescentGirl(models.Model):
    ...
    weightunit = models.CharField(max_length = 50,choices=weightunit )
    height = models.IntegerField()
    heightunit = models.CharField(max_length = 50,choices=heightunit)
    bmi= models.DecimalField(max_digits = 5,decimal_places = 2)
    waist = models.IntegerField(null=True)
    waistunit = models.CharField(max_length=20,choices=waistunit)
    hip = models.IntegerField(null=True)
    hipunit = models.CharField(max_length=20,choices=waistunit)
...
class Student(models.Model):
    ...
    weightunit = models.CharField(max_length = 50,choices=weightunit,default = False )
    height = models.IntegerField(default = False)
    heightunit = models.CharField(max_length = 50,choices=heightunit,default = False)
    bmi= models.DecimalField(max_digits = 5,decimal_places = 2,default = False)
    waist = models.IntegerField(null=True)
    waistunit = models.CharField(max_length=20,choices=waistunit,default = False)
    hip = models.IntegerField(null=True)
    hipunit = models.CharField(max_length=20,choices=waistunit,default = False)
    whratio = models.IntegerField(null=True)
    whratioderived = models.IntegerField(null=True)
