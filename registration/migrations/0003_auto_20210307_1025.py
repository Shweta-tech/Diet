# Generated by Django 3.0.8 on 2021-03-07 10:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('registration', '0002_auto_20210307_1003'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='heightunit',
            field=models.CharField(choices=[('kgs', 'kgs'), ('lbs', 'lbs')], max_length=50),
        ),
        migrations.AlterField(
            model_name='anemiclactatingmother',
            name='hipunit',
            field=models.CharField(choices=[('kgs', 'kgs'), ('lbs', 'lbs')], max_length=20),
        ),
        migrations.AlterField(
            model_name='anemiclactatingmother',
            name='uploaded_photo',
            field=models.ImageField(upload_to='AnemicLactatingMother/%Y/%m/%d'),
        ),
        migrations.AlterField(
            model_name='anemiclactatingmother',
            name='waistunit',
